...
- [Структура LectureTitle](LectureTitle.cpp)
- [Обратимая функция](invertible_function.cpp)
- [Обратимая функция с умножением и делением](invertible_function_with_mult.cpp)
### Работа с текстовыми файлами и потоками
- [Работа с файлами ч.1](read_file.cpp)
- [Работа с файлами ч.2](read_write_file.cpp)
- [Чтение и вывод таблицы](read_output_table.cpp)
...
- [Работа с сервером времени](time_server.cpp)

## 5 неделя (Финальный проект)
### [База данных](database.cpp)
